...
# 1 "./task2/zero_crossing.h" 1
# 17 "./task2/zero_crossing.h"
...
# 1 "./task3/adjust_power.h" 1
# 23 "./task3/adjust_power.h"
...
# 1 "./task4/state_change.h" 1
# 17 "./task4/state_change.h"
...
void __attribute__((picinterrupt(("")))) isr(void) {
    ...
    if (is_adc_conversion_done()) {
        ...
        if (is_crossing_zero_point()) {
            set_state_according_to_pwr_btn();
            board_pwr_pulse();
            supply_engine_power();
        }
