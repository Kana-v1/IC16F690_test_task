...
# 2 "task6/engine_manage.c" 2

# 1 "task6/engine_manage.h" 1
# 16 "task6/engine_manage.h"
# 1 "task6/../general.h" 1
# 16 "task6/../general.h"
...
# 16 "task6/engine_manage.h" 2
# 27 "task6/engine_manage.h"
    void setup_engine_managment_ports(void);
    void supply_engine_power(void);
    void start_engine(void);
    void set_engine_power_level(unsigned int lvl);
# 3 "task6/engine_manage.c" 2


volatile unsigned int current_lvl = 45;
volatile unsigned int desired_lvl = 45;
...
static void send_pulse(void) {
    ...
    float pulse_shift = current_lvl * 1/50 / 2;
    unsigned long pulse_shift_us = (unsigned long) (pulse_shift * 1, 000, 000);
