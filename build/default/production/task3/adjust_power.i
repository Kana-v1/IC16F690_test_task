...
# 16 "task3/adjust_power.h" 2
    ...
    void setup_RC7(void);
# 2 "task3/adjust_power.c" 2



volatile static unsigned int power_lvl = 0;
...
void board_pwr_pulse(void) {
    ...
    if (power_lvl == 1 && !mid_power_shift_is_running) {
        PORTCbits.RC7 = 0;
        mid_power_shift_is_running = 1;
        const float pulse_shift = 0.7 * 1/50 / 2;
